            ...
            <div class="sidebar-content">
              ...
              <ul class="sidebar-nav">
                ...
                <li class="active">
                  ...
                  <ul>
                    <li>
                      <a href="grouparticle.jsp" class="active">发布文章</a>
                    </li>
                    <li>
        ...
        <div id="main-container">
          ...
          <div id="page-content">
            ...
            <div class="block full">
              ...
              <!-- Get Started Content -->
              <form id="group" enctype="multipart/form-data" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-file-input">文章图片</label>
                  <div class="col-md-9">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-text-input">所属群组</label>
                  <div class="col-md-3">
