  ...
  <body>
              ...
              <ul class="sidebar-nav">
                ...
                <li class="active" id="teacher">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="addhandout.jsp" class="active">发布讲义</a>
                    </li>
                    <li>
        ...
        <div id="main-container">
          ...
          <div id="page-content">
            ...
            <div class="block full">
              ...
              <!-- Get Started Content -->
              <form id="handout" enctype="multipart/form-data" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-file-input">讲义图片</label>
                  <div class="col-md-9">
    ...
    <script>
      ...
      $("#submit").on('click', function () {
        var form = new FormData($('#handout')[0]);
        $.ajax({
